...
function setStylesBasedOnClass(){
    var lablewithclasses = document.getElementsByClassName('lable-color');

    for (var i= 0; i<lablewithclasses.length ; i++)
    {
        lablewithclasses[i].style.color = "red";
    }
